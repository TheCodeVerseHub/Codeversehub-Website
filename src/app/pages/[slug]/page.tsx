            ...
            <div className="min-h-screen bg-black flex flex-col">
                ...
                <div className="flex-1 flex items-center justify-center px-4 py-16">
                    <div className="text-center">
                        ...
                        <Link href="/" className="text-[#ffffff] hover:text-[#ffffff] transition-colors duration-150">
                            Return Home
                        </Link>
                    </div>
                </div>
        ...
        <div className="min-h-screen bg-black flex flex-col">
            ...
            <div className="flex-1 max-w-7xl mx-auto px-4 py-16">
                <div className="flex items-center justify-between gap-4 mb-6">
                    <Link
                        href="/"
                        className="inline-flex items-center gap-2 text-[#ffffff] hover:text-[#ffffff] transition-colors duration-150"
                    >
                    ...
                    >
                        <Link
                            href="/pages"
                            className="text-[#ffffff] hover:text-[#ffffff] font-medium transition-colors duration-150"
                        >
                            Pages
                        </Link>
                            ...
                            <div className="flex items-start gap-4">
                                {IconComponent && (
                                    <div className="doc-icon-badge flex-shrink-0">
                                        <IconComponent className="w-6 h-6 text-[#ffffff]" />
                                    </div>
                                )}
