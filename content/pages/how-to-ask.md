...
description: A guide to writing great questions that get fast, helpful answers from the community.
...
1. **Don't ask to ask** (i.e. "Can someone help me?", "Anyone know Java?")
2. **Ask directly:** "How do I [describe problem] in Java using [specific tool or library]?"
3. For more on this, check out [dontasktoask.com](https://dontasktoask.com/)
4. **Be specific about your goal.** Do you just want the last 3 characters of a string, or a file extension from a file name? (See the [XY Problem](https://xyproblem.info/) for why this matters.)
5. Include assignment/project restrictions if your question is for coursework or a specific spec
6. If your problem is resolved, please **post the solution** so that future readers can benefit
7. If you need help urgently, ping `@Volunteer` (Ping me for help), **not** `@Staff`
...
- Use the command `?close` to close threads
- Only Mods or OP can close threads
