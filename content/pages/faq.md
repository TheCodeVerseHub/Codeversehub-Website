...
description: Answers to common questions about joining, contributing to open source, code reviews, maintainership, and life inside the CodeVerse Hub Discord.
icon: help-circle
...
1. Browse our [GitHub organization](https://github.com/TheCodeVerseHub) and pick a repository.
...
Full details live in the [contributing guide](/pages/contributing).
...
The community does. Repositories live under the [TheCodeVerseHub GitHub organization](https://github.com/TheCodeVerseHub), are licensed openly (MIT or GPL), and their roadmaps are discussed in public. Maintainers steward the projects, but the direction is shaped by everyone who contributes.
...
Use the [ban appeal form](/ban-appeal) (recommended), and include evidence links if possible. If you cannot access the website, open a ModMail ticket by DMing the @ModMail bot.
