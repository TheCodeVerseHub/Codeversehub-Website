...
| `DiscordSection` | `src/components/home/DiscordSection.tsx` | Explains *what actually happens inside the Discord* — 8 areas (Learning & Help, Programming Channels, Project Showcase, Code Reviews, Open Source, Voice Events, Community Activities, Resources), each with a "why it matters" line, plus an audience strip and join CTA. |
